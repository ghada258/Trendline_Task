...
const Footer = () => {
  return (
    <div className="relative w-full mt-6">
      ...
      {/* content */}
      <div className="relative z-10 flex flex-col md:flex-row py-10 px-4 md:px-16 justify-around items-start gap-10 text-white">
        
        {/* Logo & Description */}
        <div className="flex flex-col gap-4 max-w-[324px]">
          <Image
        ...
        {/* Let Us Help & Policies container */}
            <div className="flex flex-wrap gap-6">
            {/* Let Us Help */}
            <div className='flex flex-col gap-3 min-w-[150px]'>
                <span className='font-semibold text-2xl'>Let Us Help</span>
            ...
            {/* Policies */}
            <div className='flex flex-col gap-3 min-w-[150px]'>
                <span className='font-semibold text-2xl'>Policies</span>
                <ul className='font-medium text-[#FFFFFFB2] flex flex-col gap-1'>
                <li>Refund Policy</li>
                <li>About Us</li>
        ...
        <div className='flex flex-col gap-3 w-full md:w-[369px]'>
          <span className='font-semibold text-2xl'>Send Email</span>
